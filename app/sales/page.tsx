...
import { TrendingUp, Users, Clock, Target, Calendar, Award, Zap, Phone, MessageSquare, ArrowUp, ArrowDown, Minus } from 'lucide-react';
        ...
        <div className="flex min-h-screen bg-[#0a0a0a]">
            ...
            <div className="flex-1 overflow-auto">
                <div className="p-6 max-w-7xl mx-auto">
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white">{globalStats.totalProspections}</p>
                                </div>
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-blue-400">{globalStats.avgProspectionsPerBDR.toFixed(1)}</p>
                                </div>
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-purple-400">{globalStats.avgTimeBetweenProspections.toFixed(1)}min</p>
                                </div>
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-orange-400">{globalStats.totalContacts}</p>
                                </div>
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-indigo-400">{globalStats.totalMeetings}</p>
                                </div>
                        ...
                        <div className="bg-gray-900 rounded-xl p-4 border border-gray-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-400">{globalStats.avgConversionRate.toFixed(1)}%</p>
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                                    ...
                                    {teamStats.map((member, idx) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="font-bold text-white">{member.totalProspections}</span>
                        ...
                        <div className="lg:col-span-2 bg-gray-900 rounded-xl border border-gray-800 p-4">
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="font-semibold text-white">Detalhes de Performance</h3>
                                <select
                                    value={selectedMember}
                                    onChange={(e) => setSelectedMember(e.target.value)}
                                    className="px-3 py-1 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white focus:ring-2 focus:ring-green-500"
                                >
                            ...
                            {loading ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h4 className="text-lg font-medium text-white mb-2">Nenhuma métrica registrada</h4>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full">
                                        <thead className="bg-gray-800/50">
                                            <tr>
                                                <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase">BDR</th>
                                                <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Prospecções</th>
                                                <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Tempo Médio</th>
                                                <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Contatos</th>
                                                <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Reuniões</th>
                                                <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Conversão</th>
                                        ...
                                        <tbody className="divide-y divide-gray-800">
                                            {(selectedMember === 'all' ? teamStats : teamStats.filter(t => t.name === selectedMember)).map((member) => (
                                                <tr key={member.name} className="hover:bg-gray-800/50 transition-colors">
                                                    <td className="px-4 py-3">
                                                        <span className="font-medium text-white">{member.name}</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-center">
                                                        <span className="font-semibold text-green-400">{member.totalProspections}</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-center">
                                                        <span className="text-purple-400">{member.avgTimeBetweenProspections.toFixed(1)}min</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-center">
                                                        <span className="text-white">{member.totalContacts}</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-center">
                                                        <span className="text-indigo-400">{member.totalMeetings}</span>
                                                    </td>
                                                    <td className="px-4 py-3 text-center">
                                                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                                                            member.conversionRate >= 15 ? 'bg-green-500/20 text-green-400' :
                                                            member.conversionRate >= 10 ? 'bg-yellow-500/20 text-yellow-400' :
                    ...
                    <div className="bg-gray-900 rounded-xl border border-gray-800">
                        ...
                        {loading ? (
                            ...
                            <div className="p-12 text-center">
                                ...
                                <h4 className="text-lg font-medium text-white mb-2">Nenhum registro diário</h4>
                                ...
                                <table className="w-full">
                                    <thead className="bg-gray-800/50">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase">BDR</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Prospecções</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Tempo/Prosp</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Tempo Total</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Contatos</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Reuniões</th>
                                            <th className="px-4 py-3 text-center text-xs font-medium text-gray-400 uppercase">Conversão</th>
                                        </tr>
                                    ...
                                    <tbody className="divide-y divide-gray-800">
                                        {filteredMetrics.map((metric) => (
                                            <tr key={metric.id} className="hover:bg-gray-800/50 transition-colors">
                                                ...
                                                <td className="px-4 py-3">
                                                    <span className="font-medium text-white">{metric.team_member}</span>
                                                </td>
                                                <td className="px-4 py-3 text-center">
                                                    <span className="font-semibold text-green-400">{metric.prospections_count}</span>
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-center text-indigo-400">
                                                    {metric.meetings_scheduled || 0}
                                                </td>
                                                <td className="px-4 py-3 text-center">
                                                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                                                        (metric.conversion_rate || 0) >= 15 ? 'bg-green-500/20 text-green-400' :
                                                        (metric.conversion_rate || 0) >= 10 ? 'bg-yellow-500/20 text-yellow-400' :
                                                        'bg-red-500/20 text-red-400'
                                                    }`}>
                    ...
                    {/* Insights Box */}
                    <div className="mt-6 bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-xl p-6 border border-green-500/20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-gray-900/50 rounded-lg p-4 border border-gray-800">
                                <p className="text-sm text-gray-400 mb-1">Benchmark de Prospecção</p>
                                <p className="text-lg font-semibold text-white">
                                    Um BDR consegue prospectar em média <span className="text-green-400">{globalStats.avgProspectionsPerBDR.toFixed(0)} pessoas</span> em {dateRange} dias
                                </p>
                            ...
                            <div className="bg-gray-900/50 rounded-lg p-4 border border-gray-800">
                                <p className="text-sm text-gray-400 mb-1">Melhor Performance</p>
                                <p className="text-lg font-semibold text-white">
                                    <span className="text-indigo-400">{globalStats.bestPerformer || 'N/A'}</span> lidera o ranking
                                </p>
                                <p className="text-xs text-gray-500 mt-1">
